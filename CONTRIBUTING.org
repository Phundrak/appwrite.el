...
~appwrite.el~. These are more guidelines than rules, so don’t
...
without being too vague (e.g. avoid stuff like “error” or “doesn’t
work”).
...
- [[https://github.com/Phundrak/appwrite.el/issues?q=is%3Aissue+is%3Aopen+sort%3Aupdated-desc+label%3A%22good+first+issue%22][/good first issue/]] :: These issues indicate easy to fix issues and
...
- [[https://github.com/Phundrak/appwrite.el/issues?q=is%3Aissue+is%3Aopen+label%3A%22help+wanted%22+sort%3Aupdated-desc][/help wanted/]] :: These issues might require some more work than /good
